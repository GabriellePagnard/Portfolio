...
const testimonialsData = [
  {
    ...
    text: `
      Je suis ravi de vous écrire cette lettre de recommandation pour Gabrielle, avec qui j’ai eu le plaisir de suivre une formation en développement web au sein de O'clock.
  ...
  },
  {
    ...
    text: `
      Au cours de notre collaboration, Gabrielle s'est distinguée par son professionnalisme, sa rigueur et sa capacité à gérer efficacement les différentes phases du projet. Grâce à son expertise en méthodologie Agile et à son rôle central en tant que Scrum Master, le projet a pu se dérouler de manière fluide et atteindre ses objectifs dans les délais impartis.
